 ...
 */
final class Version20210310230024 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category ADD parent_id_id INT DEFAULT NULL, ADD post_validity_interval_in_days INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category DROP parent_id_id, DROP post_validity_interval_in_days');
    }
}
